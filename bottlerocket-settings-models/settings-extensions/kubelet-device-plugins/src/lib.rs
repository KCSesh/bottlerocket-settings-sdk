...
mod test {
    ...
    fn test_serde_kubelet_device_plugins() {
        let test_json = r#"{"nvidia":{"pass-device-specs":true,"device-id-strategy":"index","device-list-strategy":"volume-mounts","device-sharing-strategy":{"strategy":"time-slicing","time-slicing":{"rename-by-default":true,"replicas":2}}}}"#;
        ...
        assert_eq!(
            ...
            KubeletDevicePluginsV1 {
                nvidia: Some(NvidiaDevicePluginSettings {
                    ...
                    device_sharing_strategy: Some(Some(NvidiaDeviceSharingStrategy {
